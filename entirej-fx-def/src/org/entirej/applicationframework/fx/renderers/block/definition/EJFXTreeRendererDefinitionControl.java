...
public class EJFXTreeRendererDefinitionControl extends EJDevBlockRendererDefinitionControl
{
    private Tree                               _table;
    private Map<String, Integer>                _columnPositions;
    private List<EJDevItemWidgetChosenListener> _itemWidgetListenerList;

    public EJFXTreeRendererDefinitionControl(EJDevBlockDisplayProperties blockDisplayProperties, Tree table, Map<String, Integer> columnPositions)
    {
        ...
        for (TreeColumn col : _table.getColumns())
        {
            col.addSelectionListener(new SelectionAdapter()
            {
                ...
                public void widgetSelected(SelectionEvent e)
                {
                    ...
                    {
                        listener.fireRendererChosen((EJDevScreenItemDisplayProperties) ((TreeColumn) e.getSource()).getData("SCREEN_ITEM"));
                    }
                }
            });
        }
