...
public class EJFXTableRendererDefinitionControl extends EJDevLovRendererDefinitionControl
{
    private Table                               _table;
    private Map<String, Integer>                _columnPositions;
    private List<EJDevItemWidgetChosenListener> _itemWidgetListenerList;

    public EJFXTableRendererDefinitionControl(EJDevLovDefinitionDisplayProperties lovDisplayProperties, Table table, Map<String, Integer> columnPositions)
    {
