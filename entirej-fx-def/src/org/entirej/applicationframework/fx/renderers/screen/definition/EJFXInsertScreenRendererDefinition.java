...
public class EJFXInsertScreenRendererDefinition extends EJFXScreenRendererDefinition implements EJDevInsertScreenRendererDefinition
{
    @Override
    public String getRendererClassName()
    {
        return "org.entirej.applicationframework.fx.renderers.screen.EJFXInsertScreenRenderer";
    }
    ...
    {
        int height = blockDisplayProperties.getInsertScreenRendererProperties().getIntProperty(EJFXScreenRendererDefinitionProperties.HEIGHT, 300);
        int width = blockDisplayProperties.getInsertScreenRendererProperties().getIntProperty(EJFXScreenRendererDefinitionProperties.WIDTH, 300);
        int numcols = blockDisplayProperties.getInsertScreenRendererProperties().getIntProperty(EJFXScreenRendererDefinitionProperties.NUM_COLS, 1);
