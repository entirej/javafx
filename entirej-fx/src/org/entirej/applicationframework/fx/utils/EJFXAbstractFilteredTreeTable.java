...
public abstract class EJFXAbstractFilteredTreeTable extends VBox
{
    private final TreeTableView<?> _tableViewer;
    private TextField       _filterText;

    public EJFXAbstractFilteredTreeTable(TreeTableView<?> tableView)
    {
        super(5);
    ...
    public TreeTableView<?> getTreeViewer()
    {
        return _tableViewer;
    }
